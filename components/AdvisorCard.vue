<template>
  <div class="col-xl-6 col-12">
    <div class="startup-category mb-4">
      <div class="advisor-form row h-100">
        <div class="col-12 mb-4 px-2 d-flex">
          ...
          <div class="w-100">
            ...
            <div class="advisor-card-advisor-achievements">
              <a class="btn d-flex openToOffers fs-13 mr-4" role="button">
        ...
        <div class="row col-12 px-2">
          ...
          <div class="col-12 mb-4">
            <div class="advisor-info-header-1">Expertise</div>
            <div v-if="advisor.expertise.length !== 0" class="advisor-info-content expertise-container">
              <div v-for="expertise in advisor.expertise" :key="`expertise-${advisor.id}-${expertise.id}`" class="expertise-item">
                {{ expertise.name }}
              </div>
            </div>
            <div v-else class="advisor-info-content expertise-container">
          ...
          <div class="col-12 mb-4">
            <div class="row">
              <!-- <div class="col-md-4">
                <div class="advisor-info-header-2">Preferred Deal Size</div>
                <div class="advisor-info-content">All</div>
              </div>
              <div class="col-md-4">
                <div class="advisor-info-header-2">Deal Closed</div>
        ...
        <div class="col-12 mt-2 px-1 d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex align-items-center justify-content-end">
            <NuxtLink class="btn btn-primary advisor-card-btn px-4" :to="localePath(`/advisors/${advisor.id}`)">
              View Profile
...
export default {
  ...
  mounted() {
    if(this.advisor.advisor_favorites === true){
      this.favorite = true;
    }
  },
  methods: {
